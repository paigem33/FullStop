...
@section('content')
    ...
    <div id="stats" class="content">
        <div class="headline-container">
			...
			<a href="{{route('stat-type.create')}}" class="new-type"><button class="btn shadow border-0 py-2 text-uppercase mr-2 ml-3"><span class="mdi mdi-plus">Create New Stat Type</button></a>
		</div>
